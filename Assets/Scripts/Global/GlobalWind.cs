...
// Recreates /com.aarthificial.pixelgraphics/Runtime/Shaders/SimplexNoise3D.hlsl
public class WindDisplacementMath
{
...
public class GlobalWind : MonoBehaviour
{
    ...
    {
        // Recreates /com.aarthificial.pixelgraphics/Runtime/Shaders/Foliage/grass_shader.shadergraph
        ...
        WindDisplacementMath.SimplexNoise3D_float(noisePosX, Instance.windScale, out float noiseX, out Vector3 _);
        WindDisplacementMath.SimplexNoise3D_float(noisePosY, Instance.windScale, out float noiseY, out Vector3 _);
