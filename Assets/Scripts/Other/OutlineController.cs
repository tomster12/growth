...
public class OutlineController : MonoBehaviour
{
    ...
    private void InitializeController()
    {
        ...
        {
            pixelOutline = Instantiate(AssetManager.GetMaterial("FX Outline Pixel"));
            pixelOutline.name = "Outline Pixel (Instance)";
        }
        else if (outlineMode == Mode.Scale)
        {
            scaleOutlineMask = Instantiate(AssetManager.GetMaterial("FX Outline Scale Mask"));
            scaleOutlineFill = Instantiate(AssetManager.GetMaterial("FX Outline Scale Fill"));
