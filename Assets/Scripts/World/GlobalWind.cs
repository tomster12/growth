...
public class GlobalWind : MonoBehaviour
{
    ...
    public static Vector2 GetWind(Vector2 pos)
    {
        ...
        SimplexNoise3D_float(noisePosX, Instance.windScale, out float noiseX, out Vector3 _);
        SimplexNoise3D_float(noisePosY, Instance.windScale, out float noiseY, out Vector3 _);
