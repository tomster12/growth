...
public class PartIndicatable : Part
{
    ...
    public bool IsVisible => ShowIndicators && !Composable.GetPart<PartHighlightable>().Highlighted && Composable.GetPart<PartInteractable>().CanInteract;
    ...
    public void Init(string iconSpriteName, Vector3 offset)
    {
        ...
        indicatorSR.sprite = SpriteSet.GetSprite(iconSpriteName);
