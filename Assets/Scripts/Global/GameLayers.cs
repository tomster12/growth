...
public class GameLayers
{
    ...
    public static Dictionary<GameLayer, GameLayerInfo> LAYER_MAPPINGS { get; private set; } = new Dictionary<GameLayer, GameLayerInfo>()
    {
        ...
        [GameLayer.World] = new GameLayerInfo { posZ = 2.0f, sceneLayer = LayerMask.NameToLayer("World") },
        [GameLayer.BackDecor] = new GameLayerInfo { posZ = 3.0f, sceneLayer = LayerMask.NameToLayer("Decor") }
    };
